        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-4">
            <div>
              ...
              <p className="text-gray-600">Welcome, {candidateData.fullName}</p>
            </div>
            <div className="flex items-center space-x-4">
              <span className="text-sm text-gray-500">{candidateData.qualification} • {candidateData.experience}</span>
              <Link
                to="/login"
